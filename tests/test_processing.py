...
def test_filter_by_state(client_data_fix, state, expected):
    assert src.processing.filter_by_state(client_data_fix, state) == expected



def test_sort_by_date_descending_order(client_data_fix):
...
def test_sort_by_date_ascending_order(client_data_fix):
...
def test_sort_by_date_same_date():
    assert src.processing.sort_by_date([{'id': 939719570, 'state': 'EXECUTED', 'date': '2018-06-30T02:08:58.425572'},
             {'id': 594226727, 'state': 'CANCELED', 'date': '2018-06-30T02:08:58.425572'},
             {'id': 615064591, 'state': 'CANCELED', 'date': '2018-06-30T02:08:58.425572'},
             {'id': 41428829, 'state': 'EXECUTED', 'date': '2018-06-30T02:08:58.425572'}]) == [{'id': 939719570, 'state': 'EXECUTED', 'date': '2018-06-30T02:08:58.425572'},
             {'id': 594226727, 'state': 'CANCELED', 'date': '2018-06-30T02:08:58.425572'},
             {'id': 615064591, 'state': 'CANCELED', 'date': '2018-06-30T02:08:58.425572'},
...
def test_sort_by_date_weong_date():
    assert src.processing.sort_by_date([{'id': 939719570, 'state': 'EXECUTED', 'date': '2018-06-sdfsdf8:58.425572'},
             {'id': 594226727, 'state': 'CANCELED', 'date': '20183214145 18:58.425572'},
             {'id': 615064591, 'state': 'CANCELED', 'date': '2018-06-30T02:08:58.425572'},
             {'id': 41428829, 'state': 'EXECUTED', 'date': '2018-06-30'}]) == 'Некорректный формат даты'